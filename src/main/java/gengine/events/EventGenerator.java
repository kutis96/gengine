...
/**
 * EventGenerator. A class so abstract it basically doesn't exist anywhere else
...
public abstract class EventGenerator {
    ...
    //  the main issue is that the EventGenerator itself could be generating the events out of basically anything
